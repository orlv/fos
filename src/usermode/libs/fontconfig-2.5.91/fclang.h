...
/* total size: 825 unique leaves: 569 */

#define LEAF0       (189 * sizeof (FcLangCharSet))
#define OFF0        (LEAF0 + 569 * sizeof (FcCharLeaf))
#define NUM0        (OFF0 + 611 * sizeof (intptr_t))
...
static const struct {
    FcLangCharSet  langCharSets[189];
    FcCharLeaf     leaves[569];
    intptr_t       leaf_offsets[611];
    FcChar16       numbers[611];
} fcLangData = {
{
    ...
    { "si",  { FC_REF_CONSTANT, 1, OFF(136,307), NUM(136,307) } }, /* 136 */
    { "sk",  { FC_REF_CONSTANT, 2, OFF(137,308), NUM(137,308) } }, /* 137 */
    { "sl",  { FC_REF_CONSTANT, 2, OFF(138,30), NUM(138,30) } }, /* 138 */
    { "sm",  { FC_REF_CONSTANT, 2, OFF(139,310), NUM(139,310) } }, /* 139 */
    { "sma",  { FC_REF_CONSTANT, 1, OFF(140,312), NUM(140,312) } }, /* 140 */
    { "smj",  { FC_REF_CONSTANT, 1, OFF(141,313), NUM(141,313) } }, /* 141 */
    { "smn",  { FC_REF_CONSTANT, 2, OFF(142,314), NUM(142,314) } }, /* 142 */
    { "sms",  { FC_REF_CONSTANT, 3, OFF(143,316), NUM(143,316) } }, /* 143 */
    { "so",  { FC_REF_CONSTANT, 1, OFF(144,66), NUM(144,66) } }, /* 144 */
    { "sq",  { FC_REF_CONSTANT, 1, OFF(145,319), NUM(145,319) } }, /* 145 */
    { "sr",  { FC_REF_CONSTANT, 1, OFF(146,306), NUM(146,306) } }, /* 146 */
    { "ss",  { FC_REF_CONSTANT, 1, OFF(147,66), NUM(147,66) } }, /* 147 */
    { "st",  { FC_REF_CONSTANT, 1, OFF(148,66), NUM(148,66) } }, /* 148 */
    { "sv",  { FC_REF_CONSTANT, 1, OFF(149,320), NUM(149,320) } }, /* 149 */
    { "sw",  { FC_REF_CONSTANT, 1, OFF(150,66), NUM(150,66) } }, /* 150 */
    { "syr",  { FC_REF_CONSTANT, 1, OFF(151,321), NUM(151,321) } }, /* 151 */
    { "ta",  { FC_REF_CONSTANT, 1, OFF(152,322), NUM(152,322) } }, /* 152 */
    { "te",  { FC_REF_CONSTANT, 1, OFF(153,323), NUM(153,323) } }, /* 153 */
    { "tg",  { FC_REF_CONSTANT, 1, OFF(154,324), NUM(154,324) } }, /* 154 */
    { "th",  { FC_REF_CONSTANT, 1, OFF(155,325), NUM(155,325) } }, /* 155 */
    { "ti-er",  { FC_REF_CONSTANT, 2, OFF(156,326), NUM(156,326) } }, /* 156 */
    { "ti-et",  { FC_REF_CONSTANT, 2, OFF(157,326), NUM(157,326) } }, /* 157 */
    { "tig",  { FC_REF_CONSTANT, 2, OFF(158,328), NUM(158,328) } }, /* 158 */
    { "tk",  { FC_REF_CONSTANT, 1, OFF(159,330), NUM(159,330) } }, /* 159 */
    { "tl",  { FC_REF_CONSTANT, 1, OFF(160,331), NUM(160,331) } }, /* 160 */
    { "tn",  { FC_REF_CONSTANT, 2, OFF(161,283), NUM(161,283) } }, /* 161 */
    { "to",  { FC_REF_CONSTANT, 2, OFF(162,310), NUM(162,310) } }, /* 162 */
    { "tr",  { FC_REF_CONSTANT, 2, OFF(163,332), NUM(163,332) } }, /* 163 */
    { "ts",  { FC_REF_CONSTANT, 1, OFF(164,66), NUM(164,66) } }, /* 164 */
    { "tt",  { FC_REF_CONSTANT, 1, OFF(165,334), NUM(165,334) } }, /* 165 */
    { "tw",  { FC_REF_CONSTANT, 5, OFF(166,335), NUM(166,335) } }, /* 166 */
    { "tyv",  { FC_REF_CONSTANT, 1, OFF(167,249), NUM(167,249) } }, /* 167 */
    { "ug",  { FC_REF_CONSTANT, 1, OFF(168,6), NUM(168,6) } }, /* 168 */
    { "uk",  { FC_REF_CONSTANT, 1, OFF(169,340), NUM(169,340) } }, /* 169 */
    { "ur",  { FC_REF_CONSTANT, 2, OFF(170,341), NUM(170,341) } }, /* 170 */
    { "uz",  { FC_REF_CONSTANT, 1, OFF(171,343), NUM(171,343) } }, /* 171 */
    { "ven",  { FC_REF_CONSTANT, 2, OFF(172,344), NUM(172,344) } }, /* 172 */
    { "vi",  { FC_REF_CONSTANT, 4, OFF(173,346), NUM(173,346) } }, /* 173 */
    { "vo",  { FC_REF_CONSTANT, 1, OFF(174,350), NUM(174,350) } }, /* 174 */
    { "vot",  { FC_REF_CONSTANT, 2, OFF(175,351), NUM(175,351) } }, /* 175 */
    { "wa",  { FC_REF_CONSTANT, 1, OFF(176,353), NUM(176,353) } }, /* 176 */
    { "wen",  { FC_REF_CONSTANT, 2, OFF(177,354), NUM(177,354) } }, /* 177 */
    { "wo",  { FC_REF_CONSTANT, 2, OFF(178,356), NUM(178,356) } }, /* 178 */
    { "xh",  { FC_REF_CONSTANT, 1, OFF(179,66), NUM(179,66) } }, /* 179 */
    { "yap",  { FC_REF_CONSTANT, 1, OFF(180,358), NUM(180,358) } }, /* 180 */
    { "yi",  { FC_REF_CONSTANT, 1, OFF(181,89), NUM(181,89) } }, /* 181 */
    { "yo",  { FC_REF_CONSTANT, 4, OFF(182,359), NUM(182,359) } }, /* 182 */
    { "zh-cn",  { FC_REF_CONSTANT, 82, OFF(183,363), NUM(183,363) } }, /* 183 */
    { "zh-hk",  { FC_REF_CONSTANT, 83, OFF(184,445), NUM(184,445) } }, /* 184 */
    { "zh-mo",  { FC_REF_CONSTANT, 83, OFF(185,445), NUM(185,445) } }, /* 185 */
    { "zh-sg",  { FC_REF_CONSTANT, 82, OFF(186,363), NUM(186,363) } }, /* 186 */
    { "zh-tw",  { FC_REF_CONSTANT, 83, OFF(187,528), NUM(187,528) } }, /* 187 */
    { "zu",  { FC_REF_CONSTANT, 1, OFF(188,66), NUM(188,66) } }, /* 188 */
},
{
    { { /* 0 */
...
},
{
    ...
    LEAF(307,273),
    /* sk */
    LEAF(308,274), LEAF(308,275),
    /* sm */
    LEAF(310, 18), LEAF(310, 75),
    /* sma */
    LEAF(312,276),
    /* smj */
    LEAF(313,277),
    /* smn */
    LEAF(314,278), LEAF(314,279),
    /* sms */
    LEAF(316,280), LEAF(316,281), LEAF(316,282),
    /* sq */
    LEAF(319,283),
    /* sv */
    LEAF(320,284),
    ...
    LEAF(325,289),
    /* ti_er */
    LEAF(326,290), LEAF(326,291),
    /* tig */
    LEAF(328,292), LEAF(328,291),
    /* tk */
    LEAF(330,293),
    /* tl */
    LEAF(331,294),
    /* tr */
    LEAF(332,295), LEAF(332,296),
    /* tt */
    LEAF(334,297),
    /* tw */
    LEAF(335,298), LEAF(335,299), LEAF(335,236), LEAF(335,300),
    LEAF(335,301),
    /* uk */
    LEAF(340,302),
    /* ur */
    LEAF(341,303), LEAF(341, 16),
    /* uz */
    LEAF(343,304),
    /* ven */
    LEAF(344, 18), LEAF(344,305),
    /* vi */
    LEAF(346,306), LEAF(346,307), LEAF(346,308), LEAF(346,309),
    /* vo */
    LEAF(350,310),
    /* vot */
    LEAF(351,311), LEAF(351, 55),
    /* wa */
    LEAF(353,312),
    /* wen */
    LEAF(354,261), LEAF(354,313),
    /* wo */
    LEAF(356,314), LEAF(356,315),
    /* yap */
    LEAF(358,316),
    /* yo */
    LEAF(359,317), LEAF(359,318), LEAF(359,319), LEAF(359,320),
    /* zh_cn */
    LEAF(363,321), LEAF(363,322), LEAF(363,323), LEAF(363,324),
    LEAF(363,325), LEAF(363,326), LEAF(363,327), LEAF(363,328),
    LEAF(363,329), LEAF(363,330), LEAF(363,331), LEAF(363,332),
    LEAF(363,333), LEAF(363,334), LEAF(363,335), LEAF(363,336),
    LEAF(363,337), LEAF(363,338), LEAF(363,339), LEAF(363,340),
    LEAF(363,341), LEAF(363,342), LEAF(363,343), LEAF(363,344),
    LEAF(363,345), LEAF(363,346), LEAF(363,347), LEAF(363,348),
    LEAF(363,349), LEAF(363,350), LEAF(363,351), LEAF(363,352),
    LEAF(363,353), LEAF(363,354), LEAF(363,355), LEAF(363,356),
    LEAF(363,357), LEAF(363,358), LEAF(363,359), LEAF(363,360),
    LEAF(363,361), LEAF(363,362), LEAF(363,363), LEAF(363,364),
    LEAF(363,365), LEAF(363,366), LEAF(363,367), LEAF(363,368),
    LEAF(363,369), LEAF(363,370), LEAF(363,371), LEAF(363,372),
    LEAF(363,373), LEAF(363,374), LEAF(363,375), LEAF(363,376),
    LEAF(363,377), LEAF(363,378), LEAF(363,379), LEAF(363,380),
    LEAF(363,381), LEAF(363,382), LEAF(363,383), LEAF(363,384),
    LEAF(363,385), LEAF(363,386), LEAF(363,387), LEAF(363,388),
    LEAF(363,389), LEAF(363,390), LEAF(363,391), LEAF(363,392),
    LEAF(363,393), LEAF(363,394), LEAF(363,395), LEAF(363,396),
    LEAF(363,397), LEAF(363,398), LEAF(363,399), LEAF(363,400),
    LEAF(363,401), LEAF(363,402),
    /* zh_hk */
    LEAF(445,403), LEAF(445,404), LEAF(445,405), LEAF(445,406),
    LEAF(445,407), LEAF(445,408), LEAF(445,409), LEAF(445,410),
    LEAF(445,411), LEAF(445,412), LEAF(445,413), LEAF(445,414),
    LEAF(445,415), LEAF(445,416), LEAF(445,417), LEAF(445,418),
    LEAF(445,419), LEAF(445,420), LEAF(445,421), LEAF(445,422),
    LEAF(445,423), LEAF(445,424), LEAF(445,425), LEAF(445,426),
    LEAF(445,427), LEAF(445,428), LEAF(445,429), LEAF(445,430),
    LEAF(445,431), LEAF(445,432), LEAF(445,433), LEAF(445,434),
    LEAF(445,435), LEAF(445,436), LEAF(445,437), LEAF(445,438),
    LEAF(445,439), LEAF(445,440), LEAF(445,441), LEAF(445,442),
    LEAF(445,443), LEAF(445,444), LEAF(445,445), LEAF(445,446),
    LEAF(445,447), LEAF(445,448), LEAF(445,449), LEAF(445,450),
    LEAF(445,451), LEAF(445,452), LEAF(445,453), LEAF(445,454),
    LEAF(445,455), LEAF(445,456), LEAF(445,457), LEAF(445,458),
    LEAF(445,459), LEAF(445,460), LEAF(445,461), LEAF(445,462),
    LEAF(445,463), LEAF(445,464), LEAF(445,465), LEAF(445,466),
    LEAF(445,467), LEAF(445,468), LEAF(445,469), LEAF(445,470),
    LEAF(445,471), LEAF(445,472), LEAF(445,473), LEAF(445,474),
    LEAF(445,475), LEAF(445,476), LEAF(445,477), LEAF(445,478),
    LEAF(445,479), LEAF(445,480), LEAF(445,481), LEAF(445,482),
    LEAF(445,483), LEAF(445,484), LEAF(445,485),
    /* zh_tw */
    LEAF(528,486), LEAF(528,487), LEAF(528,488), LEAF(528,489),
    LEAF(528,490), LEAF(528,491), LEAF(528,492), LEAF(528,493),
    LEAF(528,494), LEAF(528,495), LEAF(528,496), LEAF(528,497),
    LEAF(528,498), LEAF(528,499), LEAF(528,500), LEAF(528,501),
    LEAF(528,502), LEAF(528,503), LEAF(528,504), LEAF(528,505),
    LEAF(528,506), LEAF(528,507), LEAF(528,508), LEAF(528,509),
    LEAF(528,510), LEAF(528,511), LEAF(528,512), LEAF(528,513),
    LEAF(528,514), LEAF(528,515), LEAF(528,516), LEAF(528,517),
    LEAF(528,518), LEAF(528,519), LEAF(528,520), LEAF(528,521),
    LEAF(528,522), LEAF(528,523), LEAF(528,524), LEAF(528,525),
    LEAF(528,526), LEAF(528,527), LEAF(528,528), LEAF(528,529),
    LEAF(528,530), LEAF(528,531), LEAF(528,532), LEAF(528,533),
    LEAF(528,534), LEAF(528,535), LEAF(528,536), LEAF(528,537),
    LEAF(528,538), LEAF(528,539), LEAF(528,540), LEAF(528,541),
    LEAF(528,542), LEAF(528,543), LEAF(528,544), LEAF(528,545),
    LEAF(528,546), LEAF(528,547), LEAF(528,548), LEAF(528,549),
    LEAF(528,550), LEAF(528,551), LEAF(528,552), LEAF(528,553),
    LEAF(528,554), LEAF(528,555), LEAF(528,556), LEAF(528,557),
    LEAF(528,558), LEAF(528,559), LEAF(528,560), LEAF(528,561),
    LEAF(528,562), LEAF(528,563), LEAF(528,564), LEAF(528,565),
    LEAF(528,566), LEAF(528,567), LEAF(528,568),
},
{
    /* aa */
    0x0000,
...
static const FcChar32 fcLangCountrySets[][NUM_LANG_SET_MAP] = {
    ...
    { 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x10000000, 0x00000000, }, /* ti */
